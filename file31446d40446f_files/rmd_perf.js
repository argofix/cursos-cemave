...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 3120 }, { marker: 'pandoc', elapsed: 460 }, { marker: 'post-processor', elapsed: 40 }, { marker: 'pre-processor', elapsed: 30 }, { marker: 'render', elapsed: 4840 } ];
